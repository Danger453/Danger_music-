...
# -------------------------------------------------------
OWNER_USERNAME = getenv("OWNER_USERNAME","l_YOU_KNOW_DANGER_l")
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME","Queen_X_Pihu_Bot")
# --------------------------------------------------------
...
LOGGER_ID = int(getenv("LOGGER_ID", -1002307064756))

# Get this value from @PURVI_HELP_BOT on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", 6726472585))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Danger453/Danger_music-.git",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/l_DREAM_CLAN_DP_l")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/ll_THE_DREAM_CLAN_l")
